...
Counting policy belongs to the workspace being measured. The defaults contain no organization- or product-specific paths, and the tool never infers policy from repository names.
